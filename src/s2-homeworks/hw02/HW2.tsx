...
export const filterAffairs = (affairs: AffairType[], filterAffairs: FilterType): AffairType[] => { // need to fix any
  if (filterAffairs === "all") return affairs
  return affairs.filter(affair => affair.priority === filterAffairs)
}
